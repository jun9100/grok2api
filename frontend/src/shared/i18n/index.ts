...
Object.assign(resources.en.translation.settings.egress as unknown as Record<string, string>, {
  ...
  testAll: "Check all", testAllHelp: "Check every configured proxy node now, including disabled nodes, and update its connectivity probe result.",
  ...
  imported: "Proxy import completed: {{imported}} imported, {{skipped}} invalid or duplicate, {{filtered}} filtered out", tested: "Proxy test completed: {{healthy}} healthy, {{unhealthy}} unhealthy", testedPartial: "Connectivity probe partially completed: {{healthy}} healthy, {{unhealthy}} unhealthy, {{failed}} not completed",
  ...
  testingProgress: "Checking {{completed}} / {{total}}",
...
Object.assign(resources["zh-CN"].translation.settings.egress as unknown as Record<string, string>, {
  ...
  importText: "批量导入",
  testAll: "检测全部",
  testAllHelp: "立即检测所有已配置的代理节点（包括停用节点），并更新连通探测结果。",
  ...
  testingProgress: "检测中 {{completed}} / {{total}}",
