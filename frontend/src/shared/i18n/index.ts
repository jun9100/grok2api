...
Object.assign(resources.en.translation.settings.egress as unknown as Record<string, string>, {
  ...
  testAll: "Check all", testAllHelp: "Check every configured proxy node now, including disabled nodes. Failed nodes are removed and their account bindings are repaired; subscription sync may import a removed node again.",
  rebalance: "Balance accounts", rebalanceHelp: "Assign unbound accounts and balance automatic bindings once. Capacity is preferred, then healthy matching nodes share any overflow. Manual bindings are not changed.",
  ...
  sourceSaved: "Proxy subscription saved", sourceDeleted: "Proxy subscription deleted", sourceSynced: "Proxy subscription synced: {{imported}} imported, {{skipped}} invalid or duplicate, {{filtered}} filtered out",
  imported: "Proxy import completed: {{imported}} imported, {{skipped}} invalid or duplicate, {{filtered}} filtered out", tested: "Proxy test completed: {{healthy}} healthy, {{unhealthy}} unhealthy",
  testedAndRebalanced: "Proxy checks completed: {{healthy}} healthy, {{unhealthy}} unhealthy, {{removed}} unavailable nodes removed. Account allocation: {{assigned}} assigned, {{rebalanced}} rebalanced, {{overflowed}} over capacity, {{unplaced}} unplaced{{unplacedDetails}}",
  rebalanced: "Account allocation completed: {{assigned}} assigned, {{rebalanced}} rebalanced, {{overflowed}} over capacity, {{unplaced}} unplaced{{unplacedDetails}}", unplacedProvider: "{{scope}}: no healthy proxy for {{count}} accounts", unplacedDetails: " ({{details}})", automationSaved: "Automation saved",
  editSource: "Edit subscription", subscriptionURL: "Subscription URL", sourceDialogDescription: "Configure the subscription URL, scope, refresh interval, account capacity, and optional country or latency checks before nodes are saved.",
  importDialogDescription: "Supports plain-text or Base64 proxy lists. Optional country and latency checks run before nodes are created.",
  ...
  refreshInterval: "Subscription refresh interval (seconds)", proxyList: "Proxy list",
	importFilter: "Import filter", noImportFilter: "No limits", maxImportLatency: "Maximum latency (ms)", countries: "Countries", countriesPlaceholder: "US, SG",
	maxLatencySummary: "≤ {{value}} ms", preflightEnabled: "Preflight enabled", preflightDisabled: "No preflight",
  ...
  testingProgress: "Checking {{completed}} / {{total}}", testedIncomplete: "Checks finished: {{healthy}} healthy, {{unhealthy}} unhealthy, {{removed}} unavailable nodes removed, {{untested}} not completed",
...
Object.assign(resources["zh-CN"].translation.settings.egress as unknown as Record<string, string>, {
  ...
  importText: "批量导入",
  testAll: "检测全部",
  testAllHelp: "立即检测所有已配置的代理节点（包括停用节点），删除本次检测失败的节点并自动调配其账号；订阅同步仍可能重新导入已删除节点。",
  rebalance: "均衡分配",
  rebalanceHelp: "立即分配未绑定账号并均衡自动绑定；容量用尽时由适配的健康节点继续分摊，手动绑定不受影响。",
  ...
  sourceSynced: "订阅同步完成：导入 {{imported}}，格式跳过 {{skipped}}，筛掉 {{filtered}}",
  editSource: "编辑订阅",
  sourceDialogDescription: "配置订阅地址、作用域、刷新周期、账号容量，以及写入前的国家和延迟筛选。",
  ...
  testingProgress: "检测中 {{completed}} / {{total}}", testedIncomplete: "检测完成：可用 {{healthy}}，不可用 {{unhealthy}}，已删除 {{removed}} 个不可用节点，未完成 {{untested}}",
  testedAndRebalanced: "代理检测完成：可用 {{healthy}}，不可用 {{unhealthy}}，已删除 {{removed}} 个不可用节点；账号调配：新增 {{assigned}}，均衡 {{rebalanced}}，超容量 {{overflowed}}，未分配 {{unplaced}}{{unplacedDetails}}",
  rebalanced: "账号调配完成：新增 {{assigned}}，均衡 {{rebalanced}}，超容量 {{overflowed}}，未分配 {{unplaced}}{{unplacedDetails}}",
  unplacedProvider: "{{scope}} 无健康代理 {{count}} 个", unplacedDetails: "（{{details}}）",
  ...
  importFilter: "导入筛选", noImportFilter: "不限", maxImportLatency: "最高延迟（ms）", countries: "国家/地区", countriesPlaceholder: "US, SG",
  maxLatencySummary: "≤ {{value}} ms", preflightEnabled: "同步时预检", preflightDisabled: "不预检",
  imported: "代理导入完成：导入 {{imported}}，格式跳过 {{skipped}}，筛掉 {{filtered}}",
  importDialogDescription: "支持明文或 Base64 代理列表；国家和延迟条件会在创建节点前预检。",
});
